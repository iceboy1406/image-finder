...
const SearchResultPage: NextPage = () => {
  ...
  const { data, hasNextPage, fetchNextPage } = useInfiniteQuery(
    ...
    ({ pageParam = 1 }) =>
      PixabayImageApi.searchImage(keyword ?? '', filters, pageParam),
    {
  ...
  return (
    <div className="flex flex-col h-fit min-h-screen w-full">
      ...
      <Header>
        ...
        />
        <FilterButton
          anyFilter={JSON.stringify(filters) !== JSON.stringify(defaultFilters)}
      ...
      {data ? (
        data.pages
          ...
          .reduce((pre, curr) => [...pre, ...curr]).length === 0 ? (
          <div className="flex items-center justify-center flex-grow">
            <div className="flex flex-col gap-4 items-center">
              ...
              <p className="text-gray-600 text-lg text-center">
                ...
                <br />
                <b className="text-gray-900 text-2xl">{keyword}</b>
              </p>
            </div>
          </div>
        ) : (
      ...
      {filterModalVisibility ? (
        ...
        >
          <FilterModalCard>
            <FilterHeader onCloseButtonClick={() => hideFilterModal()} />
            <FilterList>
              <FilterListItem>
                <FilterListItemHeader icon={<BiSort />} title="Sort By" />
                <FilterListItemBody>
                  <BasicFilter
                    value={'Popular'}
              ...
              <FilterListItem>
                ...
                <FilterListItemBody>
                  ...
                  <BasicFilter
                    value="Landscape"
                    isSelected={filters.orientation === 'horizontal'}
                    onClick={() =>
                      setFilters({
                        ...filters,
                  ...
                  <BasicFilter
                    value="Portrait"
                    isSelected={filters.orientation === 'vertical'}
                    onClick={() =>
                      setFilters({
                        ...filters,
              ...
              <FilterListItem>
                ...
                <FilterListItemBody>
                  ...
                  <BasicFilter
                    value={'Vector'}
                    isSelected={filters.imageType === 'vector'}
                    onClick={() =>
                      setFilters({
                        ...filters,
                        imageType: 'vector',
                  ...
                  <BasicFilter
                    value={'Illustration'}
                    isSelected={filters.imageType === 'illustration'}
                    onClick={() =>
                      setFilters({
                        ...filters,
              ...
              <FilterListItem>
                ...
                <FilterListItemBody>
                  ...
                  />
                  <BasicFilter
                    isSelected={filters.colors === 'grayscale'}
                    value="Grayscale"
                    onClick={() =>
                      setFilters({
                        ...filters,
                  ...
                  />
                  <BasicFilter
                    isSelected={filters.colors === 'transparent'}
                    value="Transparent"
                    onClick={() =>
                      setFilters({
                        ...filters,
                ...
                <FilterListItemBody>
                  ...
                  />
                  <ColorFilter
                    selected={filters.colors === 'turquoise'}
                    onClick={() =>
                      setFilters({
                        ...filters,
                        colors: 'turquoise',
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        if (parseInt(e.target.value) < 0) {
                          ...
                          setMinimumWidth(e.target.value)
                        }
                      }}
                      onBlur={() => {
                        if (minimumWidth === '') {
                        ...
                        if (minimumWidth !== filters.minimumWidth) {
                          setFilters({
                            ...filters,
                            minimumWidth:
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      onBlur={() => {
                        ...
                        if (minimumHeight !== filters.minimumHeight) {
                          setFilters({
                            ...filters,
                            minimumHeight:
              ...
              <FilterListItem>
                <FilterListItemHeader icon={<BiCategory />} title="Category" />
                <FilterListItemBody>
                  <BasicFilter
                    value="Any"
